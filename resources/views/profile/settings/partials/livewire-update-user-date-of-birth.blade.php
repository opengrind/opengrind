    ...
    <form wire:submit.prevent="store">
      ...
      <div class="space-y-2 mb-4">
        <div class="flex items-center gap-x-2">
          ...
          <label for="hidden" class="block text-sm font-medium leading-6 text-gray-900">Never display the date of birth to anyone</label>
        </div>
        <div class="flex items-center gap-x-2">
          ...
          <label for="month_day" class="block text-sm font-medium leading-6 text-gray-900">Only show the day and the month</label>
        </div>
        <div class="flex items-center gap-x-2">
          ...
          <label for="full" class="block text-sm font-medium leading-6 text-gray-900">Display the full date of birth</label>
        </div>
      </div>
